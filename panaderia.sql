...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2023 a las 00:23:24
...
(1, '1', '12345678901', 'Tienda Jaimitos', 'fabiola@gmail.com', 'Av. 5 Mayo ', 1, 'rhuarcaya', '123', '2020-07-17', '0.00', 'A'),
(2, '1', '7889635214', 'Tienda El Chino', 'chino@yahoo.es', 'Av. Sucre 780 ', 1, 'chino', '1234', '2015-07-17', '0.00', 'A'),
(3, '1', '5555', 'MiniMarket Faby', 'f', 'San Pablo 784 ', 1, 'rhuarcaya', '123', '2022-07-17', '0.00', 'A'),
(4, '1', '89876545676', 'Tienda Dianas', 'dianas@gmail.com', ' Independencia 252', 1, 'floli', '123', '2010-07-17', '0.00', 'A'),
(5, '1', '09098767905', 'Miguel Angel', 'ma@gmail.com', 'Paso real 280', 1, 'mangel', '123', '2020-07-18', '0.00', 'A'),
(8, '2', 'VECD010418D', 'Diego', 'dv6702682@gmail.com', 'Golfo de México 451', 1, 'DiegoVC', '123', '2023-05-21', '0.00', 'A');
...
(1, '5 de mayo', '001'),
(2, 'Flor de Junioo', '002'),
(3, 'Jesús María', '003'),
(4, 'Paso real', '004'),
(5, 'Pueblo Libre', '006'),
(6, 'Paseo residencial', '007'),
(7, 'Artesa residencial', '010'),
(8, 'Juan de lo reyes', '011');
...
CREATE TABLE `fotos` (
  ...
  `des_foto` varchar(30) NOT NULL,
  `id_cliente` int(11) NOT NULL,
  `img_foto` varchar(50) NOT NULL,
...
CREATE TABLE `panes` (
  `id_pan` int(11) NOT NULL,
  `nom_pan` varchar(35) NOT NULL,
  `des_pan` varchar(100) NOT NULL,
  `pre_pan` decimal(7,2) NOT NULL,
  `img_pan` varchar(45) NOT NULL,
...
(1, 'Pan de trigo', 'Contiene trigo, levadura 3%, sal entre otros ', '2.50', 'canastilla_pan.jpg', 'A'),
(2, 'Pan de maiz', 'Contiene maiz importado con levadura importad', '2.70', 'cesta_pan02.jpg', 'A'),
(3, 'Pan de centeno', 'contiene ...', '1.80', 'cesta_pan.jpg', 'A'),
(4, 'Pan de cebada', 'Fabricado con cebada nacional', '2.50', 'cesta.jpg', 'A'),
(5, 'Pan de wong', 'Pan con semilla importada y frutillas', '5.00', 'cesta_pan02.jpg', 'A'),
(6, 'Pan caracol', 'Pan dulce', '3.50', 'cerebro.png', 'A'),
(9, 'Pan germinado', 'tiene semilla del cereal germinado, no u', '2.50', 'cesta_pan02.jpg', 'A');
...
--
ALTER TABLE `panes`
  MODIFY `id_pan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
